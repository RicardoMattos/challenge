...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { animal_id: @attendance.animal_id, dt: @attendance.dt, obs: @attendance.obs, vet_id: @attendance.vet_id }
    end
  ...
  test "should update attendance" do
    patch :update, id: @attendance, attendance: { animal_id: @attendance.animal_id, dt: @attendance.dt, obs: @attendance.obs, vet_id: @attendance.vet_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
